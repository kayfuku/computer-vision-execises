...
class Simulation(object):
    ...
    def sense(self):
        '''
        This function should sense the color at the robot's current location and update the beliefs
        '''
        # Get the color the robot sees
    ...
    def get_observed_color(self):
        '''
        This function should return the color the robot sees at its current location.
        It should also handle the case where the robot is not sure what color it sees.
        '''
        # Get the position of the robot
        y, x = self.true_pose
        true_color = self.grid[int(y)][int(x)]
